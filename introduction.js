function load_introduction (game, PHONE_SCREEN_LAYER) {
	...
	game.webpages["1"] = new Screen (0, 70, 0, new Rectangle ("introduction_registration_1_background", 0, 0, 1224, 688, 0, "rgba(255,255,255,1)"), [new Button ("introduction_name_entry_finish_button", 100, 200, 200, 300, "Next >", "18px Arial", "rgba(0,0,0,1)", 2)], [new Button ("introduction_name_text_entry", 100, 130, 500, 200, "", "24px Arial", "rgba(64,64,64,1)", 2)], [new Text ("introduction_registration_enter_name", 100, 100, 500, 150, 1, "What's your name?", "24px Arial", "rgba(0,0,0,1)")]);
	game.webpages["2"] = new Screen (0, 70, 0, new Rectangle ("introduction_registration_2_background", 0, 0, 1224, 688, 0, "rgba(255,255,255,1)"), [new Button ("introduction_partner_name_entry_finish_button", 100, 200, 200, 300, "Next >", "18px Arial", "rgba(0,0,0,1)", 2)], [new Button ("introduction_partner_name_text_entry", 100, 130, 500, 200, "", "24px Arial", "rgba(64,64,64,1)", 2)], [new Text ("introduction_registration_enter_partner_name", 100, 100, 500, 150, 1, "What's your best friend's name?", "24px Arial", "rgba(0,0,0,1)")]);
	game.webpages["3"] = new Screen (0, 70, 0, new Rectangle ("introduction_registration_3_background", 0, 0, 1224, 688, 0, "rgba(255,255,255,1)"), [], [], [new Text ("introduction_done_registration", 100, 200, 200, 500, 1, "Finished registration! You may now exit the browser.", "18px Arial", "rgba(0,0,0,1)")]);
...
function load_introduction_part2 (game) {
	...
	game.dialogs["introduction_phone_dialog_3"] = new Dialog ("introduction_phone_dialog_3", "Voice", "You're inside of me.", ["Next."]);
	game.dialogs["introduction_phone_dialog_4"] = new Dialog ("introduction_phone_dialog_4", game.player_name, "Then who are you?", ["Next."]);
	...
	game.dialogs["introduction_phone_dialog_8"] = new Dialog ("introduction_phone_dialog_8", game.player_name, "But why can you just ruin my life! If a live human, a living being, and you're just a phone.", ["Next."]);
